...
- **2026-06-22** | `lint` | pages_created: 0 | pages_updated: 0 | dead_links_delta: 0 | open_gaps: 1 | 11 nominal dead links (all benign: sandbox PNG naming mismatch + 1 cases/ prefix omission). No content gaps. Wiki ready for interview.
- **2026-06-22** | `ingest` | pages_created: 1 | pages_updated: 3 | dead_links_delta: 0 | open_gaps: 1 | Ingested official DE help center articles (2 articles). Created: sources/helpcenter-patient-pathways.md. Key findings: 5 official question types (Age, New patient, Quarterly quota, Referral, Private-only); patient-facing question wording is hardcoded by Doctolib — not configurable; referral blocking requires Doctolib directory lookup; new patient matching uses contact data + DOB + history (10-min activation lag); 3 AI product help categories visible (Phone, Consultation, Dictation) — pre-consultation history absent.
